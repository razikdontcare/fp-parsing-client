  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center mx-auto min-h-screen w-full bg-white p-2 overflow-hidden gap-2">
        ...
        <div className="flex items-center justify-center flex-col container mx-auto p-2 pt-10 md:py-20 gap-14 md:gap-24 transition-all duration-300 bg-gradient-to-b from-background-primary to-background-secondary rounded-xl">
