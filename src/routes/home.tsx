  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center mx-auto min-h-screen w-full bg-background">
        ...
        <div className="flex items-center justify-center flex-col container mx-auto py-20 gap-24">
          <div className="flex items-center justify-center flex-col gap-3">
            ...
            <p className="italic text-white text-center text-xl">
          ...
          <div className="flex items-center justify-center flex-col gap-3">
            <div className="flex flex-col gap-3 max-w-sm w-full items-center justify-center">
              <h2 className="text-white text-4xl italic font-bold">
          ...
          <div className="flex items-center justify-center flex-col gap-3">
            ...
            <div className="flex items-center justify-center container mx-auto gap-5 pt-5">
              <img
                src="/razik.jpg"
                alt="razik"
                className="aspect-square rounded-xl size-72"
              />
              <img
                src="/rika.jpg"
                alt="rika"
